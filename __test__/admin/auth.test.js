...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Alfreda83',
      password: 'ugPeghe8vxfADsF',
      email: 'Noah_Pouros@hotmail.com',
      name: 'Lillie Barrows',
      shippingAddress: [
        {
          _id: false,
          pincode: 'Implementation',
          address1: 'Switchable',
          address2: 'multimedia',
          landmark: 'Overpass',
          city: 'adapter',
      ...
      userType: 316,
      mobileNo: '(694) 944-3119',
      resetPasswordLink: {},
      loginRetryLimit: 238,
      loginReactiveTime: '2023-03-17T11:49:36.656Z',
      id: '634be6d38e206392d4c8aa65'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Burdette.Bradtke',
        'password':'uDRPKy3OUTTDZEg',
        'email':'Augustine27@yahoo.com',
        'name':'Horace Smith',
        'shippingAddress':[{
          '_id':false,
          'pincode':'withdrawal',
        ...
        'wishlist':[{
          '_id':false,
          'productId':'end-to-end'
        }],
        'userType':authConstant.USER_TYPES.Admin,
        'mobileNo':'(048) 072-7287',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Augustine27@yahoo.com', });
