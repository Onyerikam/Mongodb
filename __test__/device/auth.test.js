...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Lula.Conroy9',
      password: 'j9hShvsN1YArwKq',
      email: 'Sally58@gmail.com',
      name: 'April Hilll',
      shippingAddress: [
        {
          _id: false,
          pincode: 'connecting',
          address1: 'application',
          address2: 'deposit',
          landmark: 'Reverse-engineered',
          city: 'Rustic',
          isDefault: true,
          state: 'hierarchy',
          addressType: 'Fish',
      ...
      userType: 772,
      mobileNo: '(953) 875-1744',
      resetPasswordLink: {},
      loginRetryLimit: 500,
      loginReactiveTime: '2022-12-14T19:52:33.083Z',
      id: '634be6d38e206392d4c8aad1'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Elsa.Bernier27',
        'password':'c7Y8VAPHGU4zwEx',
        'email':'Remington.Vandervort12@gmail.com',
        'name':'Yvette Collier DDS',
        'shippingAddress':[{
          '_id':false,
          'pincode':'deposit',
          'address1':'pink',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Remington.Vandervort12@gmail.com', });
